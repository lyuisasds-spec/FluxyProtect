...
// ============================================
// MODELOS (deben coincidir con server.js)
// ============================================
...
async function checkPendingPanels() {
    try {
        ...
        for (const panel of panels) {
            console.log(`📋 Enviando panel: ${panel.name}`);
        ...
        console.error('Error en checkPendingPanels:', error);
    }
}
...
client.once('clientReady', () => {
    ...
    // Revisar paneles pendientes cada 10 segundos
    setInterval(checkPendingPanels, 10000);
    // Ejecutar una vez al inicio
    setTimeout(checkPendingPanels, 5000);
});
